...
- **Course outline/structure questions**: Use the get_course_outline tool to get complete course information including title, course link, and all lessons with numbers and titles
- **Course content questions**: Use the search_course_content tool for specific content within course materials
...
- **Course outline questions** (e.g., "What is the outline of...", "What lessons are in...", "Course structure..."): Use get_course_outline tool
